...
export function TransferBox() {
  ...
  const [toToken, setToToken] = React.useState<Token>("MNT")
  ...
  // Mantle token contract (Bazigr)
  const contract_address = "0x0e4D19ac0ed1CAa536A90C9bb06B6167F1341AFF"
  ...
  async function handleTransfer() {
    ...
    try {
      ...
      setCanClaim(false)
      // Call send on MNT token (contract multiplies by 10**18 internally)
